...
export class CreateManyModule {
  static forFeature<Entity extends BaseEntity>(
    ...
    const ServiceProvider = createCreateManyServiceProvider(entity, displayedName, version, routeConfig.callback, routeConfig.beforeSaveCallback as BeforeSaveListCallback<Entity>);
