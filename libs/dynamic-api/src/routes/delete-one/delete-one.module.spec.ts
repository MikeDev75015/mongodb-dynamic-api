...
describe('DeleteOneModule', () => {
  ...
  describe('forFeature', () => {
    it('should return a DynamicModule', () => {
      ...
      expect(spyCreateDeleteOneServiceProvider).toHaveBeenCalledWith(Entity, fakeDisplayedName, version, routeConfig.callback, routeConfig.beforeSaveCallback, routeConfig.beforeDeleteCallback, routeConfig.cascade, routeConfig.callbackRetry);
    });
