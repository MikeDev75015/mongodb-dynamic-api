...
export class DuplicateOneModule {
  static forFeature<Entity extends BaseEntity>(
    ...
    const ServiceProvider = createDuplicateOneServiceProvider(entity, displayedName, version, routeConfig.callback, routeConfig.beforeSaveCallback as BeforeSaveCallback<Entity>);
