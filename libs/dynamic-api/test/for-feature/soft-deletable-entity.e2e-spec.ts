...
describe('DynamicApiModule forFeature - Entity extends SoftDeletableEntity (e2e)', () => {
  beforeEach(() => {
  ...
  describe('DELETE /test-entities', () => {
    ...
    it('should delete many test entities (soft-delete)', async () => {
  ...
  describe('DELETE /test-entities/:id', () => {
    ...
    it('should delete a test entity by id (soft-delete)', async () => {
